...
public class PrpVO {
    ...
    private String prpNearSub; // 인근 역 코드
    ...
    private Integer substnPk; // 지하철 코드
	...
	public String getPrpNearSub() {
		return prpNearSub;
	}
	public void setPrpNearSub(String prpNearSub) {
	...
	public String toString() {
		return "PrpVO [prpPk=" + prpPk + ", prpName=" + prpName + ", prpImg=" + prpImg + ", prpType=" + prpType
				+ ", prpSuppArea=" + prpSuppArea + ", prpExclArea=" + prpExclArea + ", prpTransType=" + prpTransType
				+ ", prpDeposit=" + prpDeposit + ", prpPrice=" + prpPrice + ", prpMaintFee=" + prpMaintFee
				+ ", prpConstr=" + prpConstr + ", prpConstrYear=" + prpConstrYear + ", prpBlock=" + prpBlock
				+ ", prpFloor=" + prpFloor + ", prpUnit=" + prpUnit + ", prpAddrDetail=" + prpAddrDetail
				+ ", prpNumRooms=" + prpNumRooms + ", prpNumBaths=" + prpNumBaths + ", prpOri=" + prpOri
				+ ", prpParkingAvail=" + prpParkingAvail + ", prpTotalBlock=" + prpTotalBlock + ", prpTotalFloor="
				+ prpTotalFloor + ", prpDesc=" + prpDesc + ", prpNearSchool=" + prpNearSchool + ", prpNearSub="
				+ prpNearSub + ", prpRegTime=" + prpRegTime + ", prpNearSubDist=" + prpNearSubDist
				+ ", prpNearSchoolDist=" + prpNearSchoolDist + ", regionPk=" + regionPk + ", userPk=" + userPk
				+ ", agentPk=" + agentPk + ", substnPk=" + substnPk + ", coordPk=" + coordPk + ", predict2022="
				+ predict2022 + ", predict2023=" + predict2023 + ", predict2024=" + predict2024 + ", predict2025="
				+ predict2025 + ", getPrpPk()=" + getPrpPk() + ", getPrpName()=" + getPrpName() + ", getPrpImg()="
				+ getPrpImg() + ", getPrpType()=" + getPrpType() + ", getPrpSuppArea()=" + getPrpSuppArea()
				+ ", getPrpExclArea()=" + getPrpExclArea() + ", getPrpTransType()=" + getPrpTransType()
				+ ", getPrpDeposit()=" + getPrpDeposit() + ", getPrpPrice()=" + getPrpPrice() + ", getPrpMaintFee()="
				+ getPrpMaintFee() + ", getPrpConstr()=" + getPrpConstr() + ", getPrpConstrYear()=" + getPrpConstrYear()
				+ ", getPrpBlock()=" + getPrpBlock() + ", getPrpFloor()=" + getPrpFloor() + ", getPrpUnit()="
				+ getPrpUnit() + ", getPrpAddrDetail()=" + getPrpAddrDetail() + ", getPrpNumRooms()=" + getPrpNumRooms()
				+ ", getPrpNumBaths()=" + getPrpNumBaths() + ", getPrpOri()=" + getPrpOri() + ", getPrpParkingAvail()="
				+ getPrpParkingAvail() + ", getPrpTotalBlock()=" + getPrpTotalBlock() + ", getPrpTotalFloor()="
				+ getPrpTotalFloor() + ", getPrpDesc()=" + getPrpDesc() + ", getPrpNearSchool()=" + getPrpNearSchool()
				+ ", getPrpNearSub()=" + getPrpNearSub() + ", getPrpRegTime()=" + getPrpRegTime()
				+ ", getPrpNearSubDist()=" + getPrpNearSubDist() + ", getPrpNearSchoolDist()=" + getPrpNearSchoolDist()
				+ ", getRegionPk()=" + getRegionPk() + ", getUserPk()=" + getUserPk() + ", getAgentPk()=" + getAgentPk()
				+ ", getSubstnPk()=" + getSubstnPk() + ", getCoordPk()=" + getCoordPk() + ", getPredict2022()="
				+ getPredict2022() + ", getPredict2023()=" + getPredict2023() + ", getPredict2024()=" + getPredict2024()
				+ ", getPredict2025()=" + getPredict2025() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
