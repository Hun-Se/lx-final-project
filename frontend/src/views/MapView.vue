      ...
      <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
        ...
        >
          ...
          <span class="me-3" @click="goHome">
            ...
            <!--프로필-->
            <div class="profile">
              <img :src="user.user_image" alt="사용지 이미지" class="profile-image" />
            </div>
          </div>
          ...
          >
            <a id="sort-latest" style="margin-left: 2ex; cursor: pointer; font-weight: 800"
              >최신순</a
            >
            | <a id="sort-price" style="cursor: pointer; font-weight: 800">가격순</a> |
                  ...
                  <div class="modal-body">
                    ...
                    <nav class="navbar navbar-light bg-light">
                      <form class="form-inline">
                        <h3 style="margin-left: 3ex; margin-top: 3ex">거래 대상</h3>
                        <button
                          type="button"
                          class="btn"
                          :class="
                            filters.dealTarget === '기타' ? 'btn-primary' : 'btn-secondary'
                          "
                        ...
                        <button
                          ...
                          class="btn"
                          :class="
                            filters.dealTarget === '주택' ? 'btn-primary' : 'btn-secondary'
                          "
                    ...
                    <nav class="navbar navbar-light bg-light">
                      <form class="form-inline">
                        <h3 style="margin-left: 3ex; margin-top: 3ex">거래 유형</h3>
                        <button
                          type="button"
                          class="btn"
                          :class="activeInput === 'all' ? 'btn-primary' : 'btn-secondary'"
                    ...
                    <nav class="navbar navbar-light bg-light">
                      <form class="form-inline">
                        ...
                        <button
                          ...
                          class="btn"
                          :class="
                            filters.structure === '전체' ? 'btn-primary' : 'btn-secondary'
                          "
                        ...
                        <button
                          ...
                          class="btn"
                          :class="
                            filters.structure === '복층' ? 'btn-primary' : 'btn-secondary'
                          "
                    ...
                    <nav class="navbar navbar-light bg-light">
                      <form class="form-inline">
                        ...
                        <button
                          ...
                          class="btn"
                          :class="
                            filters.floor === '반지하층' ? 'btn-primary' : 'btn-secondary'
                          "
                    ...
                    <nav class="navbar navbar-light bg-light">
                      <form class="form-inline">
                        <h3 style="margin-left: 3ex; margin-top: 3ex">전용 면적</h3>
                        <table
                    ...
                    <ul class="property-items">
                      ...
                      >
                        ...
                        <div class="property-details">
                          <p
                            class="property-name"
                            style="font-size: 2ex; font-weight: 800; margin-top: 1ex"
                          >
                            {{ item.sales_name }}
                          </p>
...
<script setup>
  ...
  */
  ...
  function getSalesDetails(salesId) {
    return salesDetails.value.find((detail) => detail.salesDetails_id === salesId) || {};
  }
