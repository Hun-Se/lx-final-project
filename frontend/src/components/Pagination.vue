<template>
  <ul class="pagination pagination-circle pagination-outline">
    ...
    <li
      v-else
      class="page-item first m-1"
      @click="requestFunc(1, pagination.perPage)"
    >
      <a href="#" class="page-link px-0">
        <i class="ki-duotone ki-double-left fs-2"
          ><span class="path1"></span><span class="path2"></span
    ...
    <li
      v-else="pagination.page == 1"
      class="page-item previous m-1"
      @click="requestFunc(pagination.page - 1, pagination.perPage)"
    >
      <a href="#" class="page-link px-0">
        <i class="ki-duotone ki-left fs-2"></i>
      </a>
    ...
    <li
      v-else="pagination.page >= pagination.pageCount"
      class="page-item last m-1"
      @click="requestFunc(pagination.pageCount, pagination.perPage)"
    >
      <a href="#" class="page-link px-0">
        <i class="ki-duotone ki-double-right fs-2"
          ><span class="path1"></span><span class="path2"></span
...
onMounted(() => {
  console.log(
    `Pagination::onMounted 호출됨 -> pagination : ${JSON.stringify(
      props.pagination
    )}`
  );
});
