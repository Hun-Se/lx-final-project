...
# 필요한 피처 선택
X_2024 = df[['area', 'floor', 'construction_year', 'school_proximity', 'subway_proximity', 'total_floors', 'number_of_buildings']]
y_2024 = df['price_per_area']
...
xgb_model.fit(X_2024_scaled, y_2024)
