...
# 데이터 불러오기
df = pd.read_sql("SELECT * FROM real_estate_data3", con=engine1)
...
query = """
    ...
    WHERE table_schema = 'public' AND table_name = 'prp' AND column_name = 'prp_predict_2025';
    """
...
if not columns:
    ...
    with engine2.connect() as conn:
        ...
        ADD COLUMN "prp_predict_2025" NUMERIC;
        """))
        conn.commit()
    print("컬럼 'prp_predict_2025' 추가 완료")
